...
Para podermos realocar os alunos em novas variações, usamos o vetor de probabilidade com K entradas em que cada entrada k é:
...
- $$R_{real_{i}} = \hat{\beta}_{i,k}$$ (isto é, o retorno previsto pela variação que o aluno i de fato recebeu)
- $$R_{real_{i}}^{MAX} = max_k(\hat{\beta}_{k,i})$$ (isto é, o retorno máximo previsto para o aluno i)
- $$R_{proxy_i} = \hat{\gamma}_{i,k}$$ (isto é, o retorno previsto pela variação que o aluno i de fato recebeu)
- $$R_{proxy_{i}}^{MAX} = max_k(\hat{\gamma}_{i,k})$$ (isto é, o retorno máximo previsto para o aluno i)
Computar também:
